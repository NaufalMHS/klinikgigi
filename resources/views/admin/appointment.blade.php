                ...
                <div class="col-md-6">
                    <div class="d-flex flex-row-reverse">
                        <div class="row mb-4">
                            ...
                            <div class="col-auto">
                                <form action="/admin-area/appointment" method="POST" enctype="multipart/form-data">
                                    @csrf
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!--
                            <button onclick="if (confirm('Hapus appointment {{ $data -> nama_appointment }}')) { location.replace('/admin-area/appointment/delete/{{ Crypt::encrypt($data -> id_appointment) }}') }" class="btn btn-danger btn-sm">
