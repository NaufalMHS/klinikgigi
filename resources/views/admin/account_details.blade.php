...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6 col-lg-4">
                            ...
                            <input class="form-control" type="email" value="{{ Auth::user()->no_tlp }}" readonly>
                        </div>
                        <div class="mb-3 col-md-6 col-lg-4">
                            <label for="lastName" class="form-label">Alamat</label>
                            <input class="form-control" type="email" value="{{ Auth::user()->alamat }}" readonly>
                        </div>
                        ...
                        {{-- <div class="form-password-toggle mb-3 col-md-6 col-lg-4">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control" id="basic-default-password12"
                                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                    aria-describedby="basic-default-password2" value="{{ Auth::user()->password }}"
                        readonly />
            ...
            <div class="mt-2 col-lg-2 col-md-2">
                ...
                <a href="/admin-area/akun/edit/{{ encrypt(Auth::user()->id) }}/{{ true }}"
                    class="btn btn-primary me-2 form-control">Edit Akun</a>
            </div>
        </div>
        <!-- /Account -->
    </div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="formAccountDeactivation" action="/admin-area/akun/delete/{{ Crypt::encrypt(Auth::user()->id) }}/1"
