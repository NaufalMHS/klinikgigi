            ...
            <div class="hidden lg:ml-10 lg:flex lg:items-center border-l pl-4 pt-2">
                <div x-data="{ profileDekstopOpen: false }" class="ml-3 relative">
                    <div>
                        <button type="button" class="bg-white rounded-full flex text-sm focus:outline-none"
                            ...
                            <div class="text-right mr-5">
                                ...
                                <div class="text-sm text-[#AFAEC3]"></div>
                            </div>
                    ...
                    <div x-show="profileDekstopOpen" @click.outside="profileDekstopOpen = false"
                        ...
                        @if (Auth::user()->role == 3)
                        <a href="/user-area" class="block px-4 py-2 text-sm text-[#1E2B4F] hover:bg-gray-100"
                            role="menuitem" tabindex="-1" id="user-menu-item-1">Transaction</a>
                        @else
                        <a href="/admin-area" class="block px-4 py-2 text-sm text-[#1E2B4F] hover:bg-gray-100"
